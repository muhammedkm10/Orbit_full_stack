...
// import brand27 from "../../assets/brands/brand27.png";
...
const brands = [
  ...
  // { id: 27, name: "Brand Sixteen", image: brand27 },
];
...
const OurBrand = () => {
  return (
    <div className="our-brand-container">
      <Row>
        <div className="section-heading" style={{ marginTop: "10rem" ,marginBottom:'5rem'}}>
